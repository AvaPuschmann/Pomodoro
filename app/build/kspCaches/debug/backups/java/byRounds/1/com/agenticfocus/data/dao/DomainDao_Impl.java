...
public final class DomainDao_Impl implements DomainDao {
  ...
  public DomainDao_Impl(@NonNull final RoomDatabase __db) {
    this.__db = __db;
    this.__insertionAdapterOfDomainEntity = new EntityInsertionAdapter<DomainEntity>(__db) {
      @Override
      @NonNull
      protected String createQuery() {
        return "INSERT OR IGNORE INTO `domains` (`id`,`name`,`color`) VALUES (?,?,?)";
      }
    ...
    this.__preparedStmtOfDeleteById = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "DELETE FROM domains WHERE id = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object insertAll(final List<DomainEntity> domains,
  ...
  @Override
  public Flow<List<DomainEntity>> observeAll() {
    final String _sql = "SELECT * FROM domains ORDER BY name ASC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"domains"}, new Callable<List<DomainEntity>>() {
      @Override
      @NonNull
      public List<DomainEntity> call() throws Exception {
        ...
        try {
          ...
          final List<DomainEntity> _result = new ArrayList<DomainEntity>(_cursor.getCount());
          while (_cursor.moveToNext()) {
            final DomainEntity _item;
            final String _tmpId;
            ...
            _item = new DomainEntity(_tmpId,_tmpName,_tmpColor);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  public Object count(final Continuation<? super Integer> $completion) {
    final String _sql = "SELECT COUNT(*) FROM domains";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
