...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        // Mode Projet v1.1 — Story 22-2 / Sprint 20.
        // Creates tags table (mirror desktop SQLite + Supabase) for Library tags reuse
        // across projects (tag_ids) and templates.
            ...
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("""
                    CREATE TABLE IF NOT EXISTS tags (
                        ...
                        user_id TEXT NOT NULL DEFAULT '',
                        name TEXT NOT NULL DEFAULT '',
                        color TEXT NOT NULL DEFAULT '#6C6C70',
                        position INTEGER NOT NULL DEFAULT 0,
                        created_at INTEGER NOT NULL DEFAULT 0,
                        updated_at INTEGER NOT NULL DEFAULT 0
                    )
                """.trimIndent())
                db.execSQL("CREATE INDEX IF NOT EXISTS index_tags_user_id ON tags(user_id)")
            }
        }
        ...
        private val MIGRATION_19_20 = object : Migration(19, 20) {
            override fun migrate(db: SupportSQLiteDatabase) {
                // Objectif tri-état : ajout du flag "raté" explicite (cross-out).
                db.execSQL("ALTER TABLE goals ADD COLUMN is_missed INTEGER NOT NULL DEFAULT 0")
            }
        }
